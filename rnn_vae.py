...
class RnnVae:
    ...
    def __init__(self, device, params):
        ...
        self.decoder = Dncoder(device, params, self.embedding)
...
class Encoder(nn.Module):
    ...
    def __init__(self, device, params):
        ...
        self.num_directions = 2 if self.params.bidirectional_encodedr == True else 1
        ...
        self.rnn = rnn(self.params.input_dim,
                       ...
                       bidirectional=self.params.bidirectional_encodedr,
    ...
    def _flatten_hidden(self, h, batch_size):
        if h is None:
            ...
            X = torch.concat([self._flatten(h[0], batch_size), self._flatten(h[1], batch_size)], 1)
        else:  # for gru

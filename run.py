...
def main():
    ...
    for e in range(argslist.n_epoch+1):
        ...
        if e % 100 == 0: 
            ...
            torch.save(moco.state_dict(), f'moco-epoch_{argslist.temperature}_{argslist.lr}_{e}.pt')
    print('trained finished..')
    torch.save(moco.state_dict(), 'moco_final_{argslist.temperature}_{argslist.lr}.pt')
